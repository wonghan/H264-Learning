...
private: // 根据文档，添加SPS成员
	...
	UINT32 m_max_frame_num; // frame num的上限，此处保存MaxFrameNum的值，MaxFrameNum = 2^( log2_max_frame_num_minus4 + 4 ),其中SPS的参数 log2_max_frame_num_minus4 按照前面的公式用于得出frame_num 相关的变量 MaxFrameNum 的值，log2_max_frame_num_minus4 的【取值范围0-12】
	UINT8 m_poc_type; // pic_order_cnt_type，poc的类型，是指解码图像顺序的计数方法，一般为0，值为1不常用【取值范围0-2】
	// if( pic_order_cnt_type == 0 ){
	UINT32 m_max_poc_cnt; // log2_max_pic_order_cnt_lsb_minus4，表示poc图像索引值的上限，表示图像顺序数解码过程中的变量 MaxPicOrderCntLsb 的值，公式 MaxPicOrderCntLsb = 2^( log2_max_pic_order_cnt_lsb_minus4 + 4 ),log2_max_pic_order_cnt_lsb_minus4 的【取值范围0-12】
	// }
